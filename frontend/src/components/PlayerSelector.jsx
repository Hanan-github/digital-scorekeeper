...
export const PlayerSelector = () => {
                ...
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center gap-3">
                    <div 
                      ...
                      style={{
                        backgroundColor: isSelected ? 'rgba(255,255,255,0.2)' : teamData.color + '20',
  ...
  const getBenchPlayers = (team) => {
    const activePlayers = team === 'home' ? homeActivePlayers : awayActivePlayers;
    ...
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            {renderTeamPlayers('home', homeActivePlayers, homeTeam, homePlayerStats)}
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            {renderTeamPlayers('away', awayActivePlayers, awayTeam, awayPlayerStats)}
          </CardContent>
        </Card>
      </div>
      ...
      <Dialog open={subDialogOpen} onOpenChange={setSubDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Seleccionar Sustituto</DialogTitle>
            <DialogDescription>
              Elige un jugador del banquillo para sustituir
            </DialogDescription>
          </DialogHeader>
